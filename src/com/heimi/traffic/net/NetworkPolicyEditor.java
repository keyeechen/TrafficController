...
public class NetworkPolicyEditor {
    ...
    private static NetworkTemplate buildUnquotedNetworkTemplate(NetworkTemplate template) {
        ...
        String strippedNetworkId;
        try {
           // final String strippedNetworkId = WifiInfo.removeDoubleQuotes(networkId);
        	Class serviceManager = Class.forName("android.net.wifi.WifiInfo");
            Method method = serviceManager.getMethod("removeDoubleQuotes", String.class);
	        strippedNetworkId = (String) method.invoke(serviceManager.newInstance(), networkId);
